        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 ">
          <div>
            <p>
              ...
              <a
                href="#"
                class="block text-2xl font-medium  hover:text-primary-100/75 text-gray-200 sm:text-3xl"
              >
                0123456789
              </a>
            </p>
            ...
            <ul class="mt-8 flex gap-6 justify-center">
              <li>
                <a
                  href="/"
                  rel="noreferrer"
                  target="_blank"
                  class=" transition hover:opacity-75 opacity-60 text-primary-100"
                >
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 ">
            <div>
              <p class="font-medium text-gray-400">Zweig</p>

              <ul class="mt-6 space-y-4 text-sm">
                <li className="flex group">
                <FaLocationDot className="transition text-primary-100/60 group-hover:text-primary-200 text-xl"/>
                  <p class=" transition group-hover:opacity-75 text-gray-200 cursor-pointer">
